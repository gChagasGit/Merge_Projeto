...
class GeneratePDF {
  ...
  String _getValueIndex(ItemVenda itemVenda, int col) {
    switch (col) {
      case 0:
        return '40059000367${itemVenda.produto.cod}';
      case 1:
        return itemVenda.produto.descricao;
      case 2:
        return itemVenda.quantidadeVendida.toString();
      case 3:
        return _formatValue(itemVenda.valorVendido);
      case 4:
        return _formatValue(itemVenda.valorVendido * itemVenda.quantidadeVendida);
    }
    return '';
  }
