...
class CadastrarProduto extends StatefulWidget {
  ...
  CadastrarProduto({ProdutoCtrl? produtoCtrl}) {
                  ...
                  child: ElevatedButton(
                    onPressed: () async {
                      ...
                      if (isValid) {
                        ...
                        novo.cod = _cod.text;
                        novo.descricao = _descricao.text;
                        novo.valorCompra = double.parse(_valorCompra.text);
                        novo.valorVenda = double.parse(_valorVenda.text);
                        novo.quantidadeAtual =
                            double.parse(_quantidadeAtual.text);
                        novo.quantidadeMinima =
                            double.parse(_quantidadeMinima.text);
                        // novo.unidade = _unidade.text;
                        novo.unidade = unidadeProduto.toString();
                        novo.status = true;
